...
- Think and research in English and always respond in Chinese.
...
npx skills check
npx skills update
npx skills add [--yes] [--global] <owner>/<repo>
```

Claude Code built-in: `/fewer-permission-prompts` — scans transcripts and adds frequent read-only commands to the permission allowlist.
